...
export default function Home() {
  return (
    <article className=" w-full h-full flex flex-col items-center gap-4 sm:gap-8">
      ...
      <section className="flex-1 self-stretch rounded-box bg-base-200 p-4 text-base-content text-justify  overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb scrollbar-thumb-neutral">
